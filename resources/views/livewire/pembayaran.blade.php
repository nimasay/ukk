                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="paket_nama_paket">Paket </label>
                                    <input value="{{$transaksi->paket->nama_paket}}" readonly type="text" class="form-control" id="paket" >
                            </div>
                            <div class="form-group">
                                <label for="berat"> Berat</label>
                                <input value="{{$transaksi->barang->berat}} Kg" readonly type="text" class="form-control" id="berat">
                            </div>
                            <div class="form-group">
                                <label for="total_bayar">Total Bayar</label>
                                <input value="Rp. {{number_format($transaksi->total_bayar)}}" readonly type="text" class="form-control" id="total_bayar">
                            </div>
                        </div>
                   </div>
               </div>
